    ...
    <div align="center" ; style="padding: 70px;">
        <table>
            <tr style="background-color:black">
                <th style="padding: 10px; font-size:30px; color:white;">Doctor name</th>
                <th style="padding: 10px; font-size:30px; color:white;"> Date</th>
                <th style="padding: 10px; font-size:30px; color:white;">message</th>
                <th style="padding: 10px; font-size:30px; color:white;"> Status</th>
                <th style="padding: 10px; font-size:30px; color:white;"> cancel appointment</th>
            </tr>
            ...
            <tr style="background-color: black;" align="center">
                ...
                <td style="padding: 10px; color:white;"><a class="btn btn-danger" onclick="return confirm('are you sure to delet this ')" href="{{url('cancel_appoint', $appoints->id)}}">cancel</a></td>
            </tr>
            @endforeach
        </table>
    </div>
